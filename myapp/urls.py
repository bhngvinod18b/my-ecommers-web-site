...
urlpatterns = [
    ...
    path('success/<int:id>/', views.succes_page, name='succes_page'),
    ...
    path('wishlist/<int:id>/', views.my_wishlist, name='my_wishlist'),
    path('wishlist/', views.wishlist_list, name='wishlist_list'),
    path('wishlist-success/', views.wishlist_sucses, name='wishlist_sucses'),
